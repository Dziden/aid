...
Процедура ОтправитьSMS()
	...
	// отправка
	РезультатОтправки = Аид_ОтправкаSMS.ОтправитьSMS(МассивНомеров, ТекстСообщения, ИмяОтправителя, ОтправлятьВТранслите);
...
Функция СтатусДоставки(ИдентификаторСообщения)
	...
	РезультатДоставки.Статус = Аид_ОтправкаSMS.СтатусДоставки(ИдентификаторСообщения);
...
Функция НастройкаОтправкиSMSВыполнена(Организация)
	...
	Возврат Аид_ОтправкаSMS.НастройкаОтправкиSMSВыполнена(Организация);
