...
Функция ПриОпределенииНастроек() Экспорт
	...
	ОбщиеРеквизитыДерево = Аид_ШаблоныСообщенийСлужебный.ОпределитьОбщиеРеквизиты();
	Настройки.ОбщиеРеквизиты = Аид_ШаблоныСообщенийСлужебный.ОбщиеРеквизиты(ОбщиеРеквизитыДерево);
	Настройки.ПредметыШаблонов = Аид_ШаблоныСообщенийСлужебный.ОпределитьПредметыШаблонов();
	
	Аид_ШаблоныСообщенийПереопределяемый.ПриОпределенииНастроек(Настройки);
